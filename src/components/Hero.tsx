...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[15] pointer-events-none bg-[#f3e9d2] mix-blend-multiply opacity-40" />
      
      {/* Crispy Noise Overlay */}
      <div 
        className="absolute inset-0 z-[15] pointer-events-none opacity-[0.3] mix-blend-overlay"
