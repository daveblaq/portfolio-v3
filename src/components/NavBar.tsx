    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link href="https://www.tiktok.com/@davee.codes" target="_blank" className="text-slate-500 hover:text-primary-500 transition-colors">
        ...
        >
          <nav className="flex flex-col px-6 py-6 gap-6">
            ...
            <div className="flex items-center gap-6 mt-2 pt-6 border-t border-slate-200">
              ...
              <Link href="https://www.tiktok.com/@davee.codes" target="_blank" className="text-slate-500 hover:text-primary-500">
